...
class HttpResponseImplementationTest {

    HttpResponseImplementation httpResponse;
    @Mock
    ...
    @BeforeEach
    void setUp(){
        this.httpResponse = new HttpResponseImplementation(this.httpRequestModel, this.unwrappedHttpResponse);
    }
