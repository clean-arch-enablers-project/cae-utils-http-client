...
public class FinalHttpRequestFactory {
    ...
    private static void setUriInto(HttpRequest.Builder finalHttpRequestBuilder, AbstractHttpRequestModel httpRequestModel) {
        setPathVariablesInto(httpRequestModel);
    ...
    private static void setPathVariablesInto(AbstractHttpRequestModel requestModel) {
        requestModel.pathVariables.forEach(pathVariable -> pathVariable.buildPathVariableInto(requestModel));
    }
